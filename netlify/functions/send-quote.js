...
exports.handler = async function (event) {
  ...
  const M365_USER = process.env.M365_USER;
  const M365_PASS = process.env.M365_PASS;
  ...
  // 1 — Business notification via Microsoft 365 SMTP (no "unverified" warning)
  if (M365_USER && M365_PASS) {
    try {
      ...
      console.error('M365 SMTP error:', err.message);
    }
  } else {
    console.warn('M365_USER or M365_PASS not set — skipping business notification');
  }

  // 2 — Auto-reply to client via Resend
            ...
            <body style="margin:0;padding:0;background:#f4f4f4;font-family:Arial,sans-serif;">
              <div style="max-width:560px;margin:40px auto;background:#ffffff;border-radius:4px;overflow:hidden;">
                ...
                <div style="padding:36px 40px;">
                  <p style="font-size:16px;color:#333;line-height:1.6;">Hi <strong>${first_name}</strong>,</p>
                  ...
                  <div style="margin:28px 0;padding:20px 24px;background:#f8f9fb;border-left:3px solid #82A0CC;">
                    <h3 style="margin:0 0 10px;font-size:13px;letter-spacing:0.12em;text-transform:uppercase;color:#0c2d3a;">Warranties &amp; Liability</h3>
                    <p style="margin:0;font-size:14px;color:#555;line-height:1.7;">
                      We stand behind our workmanship. Labor performed by Ravelo AV Technologies LLC is warranted for
                      <strong>30 days</strong> after installation. Manufacturer warranties apply separately to any equipment or products installed.
                    </p>
                  </div>
